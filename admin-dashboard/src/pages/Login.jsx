...
const Login = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Move diagonally like the splash (translateX + translateY loop)
      x -= 3;
      y -= 2;
      if (x < -w * 2) x = 0;
      if (y < -h * 2) y = 0;
      ...
      // Draw a large gradient that covers 4x the screen
  ...
  const handleForgotSendCode = async () => {
    ...
    // await authAPI.sendResetCode(forgotEmail);
    setTimeout(() => {
  ...
  const handleForgotVerifyCode = async () => {
    ...
    // await authAPI.verifyResetCode(forgotEmail, forgotCode);
    setTimeout(() => {
      setForgotLoading(false);
      setForgotStep(3);
    }, 1000);
  ...
  const handleForgotResetPassword = async () => {
    ...
    // await authAPI.resetPassword(forgotEmail, forgotCode, newPassword);
    setTimeout(() => {
      setForgotLoading(false);
  ...
  return (
    <div style={{
      ...
      {/* ── Centered title across full page ── */}
      <div style={{
        ...
        <div style={{
          ...
          borderRadius:2, marginBottom:'8px',
        }} />
        <p style={{
          fontSize:'18px', fontWeight:500,
          color:'rgba(228, 224, 224, 0.99)',
          ...
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            ...
            {forgotStep === 2 && (
              <>
                ...
                <p style={{ color:'rgba(255,255,255,0.4)', fontSize:13, marginBottom:4, lineHeight:1.6 }}>
                ...
                <p style={{ fontSize:11, color:'rgba(255,255,255,0.25)', marginBottom:20, textAlign:'center' }}>
                  Didn't receive it?{' '}
                  <span onClick={() => { setForgotStep(1); setForgotError(''); }} style={{ color:'#a78bfa', cursor:'pointer' }}>
                    Resend code
                  </span>
                </p>
      ...
      {/* ── LEFT: Animated background panel ~60% width ── */}
      <div style={{
        width: '60%',
        position: 'relative',
        overflow: 'hidden',
      ...
      <div style={{
        ...
        <div style={{ position:'relative', zIndex:1 }}>
          ...
          <p className="fu2" style={{ fontSize:'13px', color:'rgba(255,255,255,0.38)', marginBottom:'30px' }}>
