...
const Field = ({ field, placeholder, keyboardType, secureTextEntry, autoCapitalize, formData, errors, handleChange }) => (
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.keyboardView}>
        <ScrollView contentContainerStyle={styles.scrollView} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.formContainer}>
            ...
            <Field field="section" placeholder="Section" formData={formData} errors={errors} handleChange={handleChange} />
            ...
            <View style={styles.fieldWrap}>
              <View style={styles.passwordWrap}>
                <TextInput
                  style={[styles.inputPassword, errors.confirmPassword && styles.inputError]}
            ...
            <TouchableOpacity onPress={handleRegister} disabled={loading}>
              <LinearGradient colors={['#8B5CF6', '#EC4899']} style={styles.registerButton}>
...
const styles = StyleSheet.create({
  ...
  registerButton: { borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 8 },
  registerButtonText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
  loginLink: { marginTop: 20, alignItems: 'center', marginBottom: 30 },
  loginText: { color: '#999', fontSize: 14 },
  loginTextBold: { color: '#EC4899', fontWeight: 'bold' },
  passwordWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)' },
  inputPassword: { flex: 1, padding: 16, color: '#fff', fontSize: 16 },
